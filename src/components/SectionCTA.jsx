...
import { idNavLink5 } from "../constants";
...
const CTA = () => (
  <section id={idNavLink5} className={`${styles.flexCenter} ${styles.marginY} ${styles.padding} sm:flex-row flex-col bg-blue-gradient rounded-[20px] box-shadow feature-card`}>
    ...
    <div className={`${styles.flexCenter} sm:ml-10 ml-0 sm:mt-0 mt-10`}>
      <Button label='Watch for free' url='https://www.youtube.com/watch?v=3kaGC_DrUnw' />
    </div>
